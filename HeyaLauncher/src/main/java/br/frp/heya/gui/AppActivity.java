...
import static br.frp.heya.gui.AppSettingsOverlayDialog.*;
...
public class AppActivity extends CustomFragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        {
            // Set size of items
            mGridView.setColumnWidth(Tools.getPixelFromDip(appIconSize));
        }
    ...
    {
        if(mMovingApp[0] == null && keycode == KeyEvent.KEYCODE_BUTTON_X && !mSettings.getChildModeObserverEnabled())
        {
            ...
            if(mGridView.hasFocus())
            {
                ...
                appSettingsDialog.setOnActionClickedHandler(new OnActionClickedHandler() {
                    ...
                    public void onActionClicked(ActionEnum action) {
                        ...
                        appSettingsDialog.startRemoving();
                        ...
                        switch (action) {
                            case SORT:
                                ...
                                break;
                            case DETAILS:
                                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("ouya://launcher/details?app="+appInfo.packageName)));
                                break;
                            case SETTINGS:
